            ...
            <div className="flex justify-between items-center h-24">
              ...
              <div className="flex items-center gap-6">
                ...
                <Link href="/checkout?plan=basico&cycle=mensual">
                  <Button className="bg-[#F5C518] text-[#0D1117] hover:bg-[#D4A915] font-bold rounded-full px-8 h-12">Prueba Gratis</Button>
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="max-w-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-5 mb-10">
                  <Link href="/checkout?plan=basico&cycle=mensual">
                    <Button size="lg" className="bg-[#F5C518] text-[#0D1117] hover:bg-[#D4A915] text-lg px-10 py-7 font-bold rounded-full shadow-xl">Empezar Prueba Gratis</Button>
                  </Link>
                  <Button size="lg" variant="outline" className="border-2 border-white/50 text-white hover:bg-white/10 text-lg px-10 py-7 rounded-full bg-transparent">Ver Precios</Button>
                </div>
                <p className="text-white/60 text-sm italic">Prueba gratuita de 14 días • Sin tarjeta de crédito • Soporte en español</p>
              </div>
              ...
              <div className="relative hidden lg:block">
                <div className="relative w-[550px] h-[600px] ml-auto">
                  ...
                  <div className="absolute inset-0 rounded-[40px] overflow-hidden -rotate-2">
                    <img src="https://images.unsplash.com/photo-1556157382-97eda2d62296?w=900&q=90" alt="Técnico JC ONE FIX" className="w-full h-full object-cover scale-110" />
                  </div>
      ...
      <section id="features" className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[{ icon: Package, title: 'Gestión de Inventario', desc: 'Control de stock en tiempo real.' }, { icon: CreditCard, title: 'Pagos Integrados', desc: 'Procesamiento seguro y rápido.' }, { icon: Calendar, title: 'Citas Online', desc: 'Sistema de reserva para clientes.' }, { icon: FileText, title: 'Gestión de Tickets', desc: 'Sistema completo de reparaciones.' }].map((feature, i) => (
