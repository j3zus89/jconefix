...
const BADGE: Record<string, { label: string; cls: string }> = {
  ...
  reparado: { label: 'Reparado', cls: 'bg-[#F5C518]/10 text-[#F5C518] border-[#F5C518]/20' },
  completed: { label: 'Completado', cls: 'bg-[#F5C518]/10 text-[#F5C518] border-[#F5C518]/20' },
  repaired_collected: { label: 'Entregado', cls: 'bg-[#F5C518]/10 text-[#F5C518] border-[#F5C518]/20' },
  delivered: { label: 'Entregado', cls: 'bg-[#F5C518]/10 text-[#F5C518] border-[#F5C518]/20' },
  issued: { label: 'Emitido', cls: 'bg-[#F5C518]/10 text-[#F5C518] border-[#F5C518]/20' },
